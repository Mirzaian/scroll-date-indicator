...
### Changed
- **Renamed** the package from `@mirzaian/scroll-date-indicator` to `scroll-date-indicator`. The old scoped package is deprecated; please update your imports and `package.json`.
